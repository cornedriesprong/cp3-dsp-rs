...
impl Kick {
    pub fn new(pitch_hz: f32, pitch_env_amt: f32, click_amt: f32, release_ms: f32) -> Self {
        Self {
            pitch_hz,
            pitch_env_amt,
            osc: Osc::new(Waveform::Sine),
            amp_env: AR::new(1.0, release_ms, CurveType::Exponential { pow: 3 }),
            pitch_env: AR::new(0.0, release_ms, CurveType::Exponential { pow: 3 }),
            click_amt,
            click_env: AR::new(0.0, 10.0, CurveType::Exponential { pow: 3 }),
            noise: Osc::new(Waveform::Noise),
        }
    }
...
impl Burst {
    pub fn new(release: f32) -> Self {
        Self {
            env: AR::new(0.0, release, CurveType::Exponential { pow: 2 }),
            noise: Osc::new(Waveform::Noise),
        }
    }
